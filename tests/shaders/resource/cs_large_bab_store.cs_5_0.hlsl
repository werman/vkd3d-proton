...
void main()
{
    ...
    fb.load1 = uav.Load(byte_offset);

    uint2 v2 = uav.Load2(byte_offset);
    fb.load2_x = v2.x;
    fb.load2_y = v2.y;

    uint3 v3 = uav.Load3(byte_offset);
    fb.load3_x = v3.x;
    fb.load3_y = v3.y;
    fb.load3_z = v3.z;

    uint4 v4 = uav.Load4(byte_offset);
    fb.load4_x = v4.x;
    fb.load4_y = v4.y;
    fb.load4_z = v4.z;
    fb.load4_w = v4.w;

    uav.Store4(byte_offset, v4 + uint4(1, 1, 1, 1));
